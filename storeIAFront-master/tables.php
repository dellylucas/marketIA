  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="tables.php">
        ...
        <div class="sidebar-brand-text mx-3">Maketplace <sup>ISFW2</sup></div>
      </a>
      <!-- Divider -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Tables data base</h1>
          <p class="mb-4">DataTables actually used  <a target="_blank" href="https://datatables.net">MySQL system</a>.</p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">DataTables Example Item</h6>
            </div>
            <div class="card-body">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; DAVID GARCIA </span>
            <span>FABIAN LUCAS </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">David Garcia</span>
                <img class="img-profile rounded-circle" src="https://scontent-bog1-1.xx.fbcdn.net/v/t1.0-9/43173584_1807628239290641_3231534776489869312_n.jpg?_nc_cat=104&_nc_eui2=AeGwEfRdFAAHBpqbjztpSrbPmMiyRLj35liu1NH1Uo0FUcmVwtATtPh7NQHN-fOTd4GvtPk4TDH5njumqc8AqADPWYxChlwqaUqGU-UmGaNQlw&_nc_oc=AQli6vBqjTKAdqlY_zRrm9Ehdlv4DGXFklE2PLalBPUCOdjy3mm-ic5SFOvYUJnMXPw&_nc_ht=scontent-bog1-1.xx&oh=302cafbc79bf48cecab73251b457f4a7&oe=5E3B1958">
              </a>
              <!-- Dropdown - User Information -->
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Market place</h1>
 ...
 <!-- DataTales Example -->
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="80%" cellspacing="1">
                  <thead>
                  
                  
                  
                    <tr>
                      <th><a href="ItemT.php"><img class="img-profile rounded-circle" src="https://http2.mlstatic.com/xiaomi-redmi-note-7-64gb-48mp-4000mah-full-hd-obsequio-D_NQ_NP_982071-MPE30220339167_052019-F.jpg" width="150" height="150" ></th>
                      <th><a href="ItemT.php"><img class="img-profile rounded-circle" src="https://http2.mlstatic.com/control-gamepad-bluetooth-celular-android-pc-tv-box-D_NQ_NP_751525-MCO32282245512_092019-F.webp" width="150" height="150" ></th>
                      <th><a href="ItemT.php"><img class="img-profile rounded-circle" src="https://fotografiamejorparavendermas.com/wp-content/uploads/2017/08/La-luz-en-la-fotografia-de-producto-Luz-suficiente.jpg" width="150" height="150" ></th> 
                      <th><a href="ItemT.php"><img class="img-profile rounded-circle" src="https://fotografiamejorparavendermas.com/wp-content/uploads/2017/08/La-luz-en-la-fotografia-de-producto-Luz-suficiente.jpg" width="150" height="150" ></th> 
                    </tr>
                    <tr>
                      <th><a href="ItemT.php"><img class="img-profile rounded-circle" src="https://fotografiamejorparavendermas.com/wp-content/uploads/2017/08/La-luz-en-la-fotografia-de-producto-Luz-suficiente.jpg" width="150" height="150" ></th>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; DAVID GARCIA xDSAA dDFE sdeerf  ffderr </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
